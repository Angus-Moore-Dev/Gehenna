...
export default function Reactions({ reactions, me, post }: { reactions: Reaction[], me: Profile | null, post: Post })
{
    ...
    return <section className="flex flex-row gap-4 items-center">
        <div className="flex flex-row gap-4 items-center">
            <div className="transition p-2 rounded-xl w-fit text-green-500 hover:text-white hover:bg-green-500 hover:cursor-pointer aria-checked:bg-green-500 aria-checked:text-white" 
        ...
        <div className="flex flex-row gap-4 items-center">
            <div className="transition p-2 rounded-xl w-fit text-red-500 hover:text-white hover:bg-red-500 hover:cursor-pointer aria-checked:bg-red-500 aria-checked:text-white" 
            aria-checked={reactionsData.some(reaction => reaction.userId === me?.id && !reaction.upvote)}
            onClick={async () => {
                // Update the post likes.
                if (me)
